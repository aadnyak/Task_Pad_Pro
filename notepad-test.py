...
def newFile():
    global file
    root.title("Untitled - Notepad with Traslator and Calculator")
    file = None
...
def saveFile():
    ...
    if file == None:
        ...
        if file =="":
            ...
            root.title(os.path.basename(file) + " - Notepad with Traslator and Calculator")
...
def traslate():
    subprocess.call(["python", "D:/TaskPad_Pro/Notepad Translator + Calculator/google_test.py"])

def calculate():
    subprocess.call(["python", "D:/TaskPad_Pro/Notepad Translator + Calculator/calculator_test.py"])
    
def todo():
    subprocess.call(["python", "D:/TaskPad_Pro/Notepad Translator + Calculator/todolistdemo.py"])

def paintt():
    subprocess.call(["python", "D:/TaskPad_Pro/Notepad Translator + Calculator/paintfinaldone.py"])
